        ...
        <div className='m-2 col-span-3 bg-secondary flex'>
          <div className='m-auto flex flex-col'>
            ...
            <form className='my-8 mx-auto ' onSubmit={handleLogin}>
              ...
              {/* <div className='ml-7'>
                <button type="button" class="text-gray-500 bg-white hover:bg-white/80 focus:ring-4 focus:outline-none focus:ring-white/50 font-medium rounded-lg text-sm px-5 py-2.5 
                text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2" onClick={() => google().then(setTimeout(() => navigate("/home"), 3000))}>
