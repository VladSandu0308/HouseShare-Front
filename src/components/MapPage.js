...
const MapPage = () => {
  ...
  return (
    <div className='grid grid-cols-2 w-screen h-screen bg-primary'>
      <div className='bg-white my-4 ml-4'>
        <div className='w-12 h-12 ml-2 mt-2 relative rounded-full bg-secondary shadow-3xl flex'>
      ...
      <div className='bg-secondary my-4 mr-4 flex'>
        <div className="text-white relative right-8 mt-3">
